...
CREATE TABLE `patient_case_info` (
  ...
  `charge_doctor` varchar(20) COMMENT '主治医师',
  `charge_nurse` varchar(20) COMMENT '护理员',
  `in_time` datetime COMMENT '入住时间',
  `is_leave` int COMMENT '是否出院',
...
CREATE TABLE `medicine_catalog`  (
  ...
  `drug_type` varchar(30) COMMENT '药品类别',
...
CREATE TABLE `warehose_storage`  (
  ...
  `goods_type` varchar(30) COMMENT '货物类别',
...
CREATE TABLE `order_goods`  (
  ...
  `goods_type` varchar(30) COMMENT '商品类别',
  `goods_price` double COMMENT '单价',
