...
CREATE TABLE `organize_depart`  (
  ...
  `depart_name` varchar(30) COMMENT '部门名',
...
CREATE TABLE `staff_doctor`  (
  ...
  `stuff_phone` varchar(20) COMMENT '电话',
  `stuff_email` varchar(50) COMMENT '邮箱',
  `stuff_adress` varchar(200) COMMENT '住址',
  `depart_name` varchar(30) COMMENT '部门',
  `staff_authority` varchar(20) COMMENT '职位',
  `in_time` datetime COMMENT '入职时间',
...
CREATE TABLE `daily_task`  (
  ...
  `patient_id` varchar(20) COMMENT '负责的病人',
...
CREATE TABLE `patient_info`  (
  `id` int NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `patient_id` varchar(20) COMMENT '编号',
  ...
  `charge_nurse` varchar(30) COMMENT '看护员',
...
CREATE TABLE `paitent_cost_detail`  (
  `id` int NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `patient_id` varchar(20) NULL DEFAULT  NULL COMMENT '病人编号',
  `case_id` varchar(20) COMMENT '病例编号',
...
CREATE TABLE `illness_catalog`  (
  `ill_id` varchar(36) NOT NULL PRIMARY KEY COMMENT '疾病编号',
...
CREATE TABLE `warehose_storage`  (
  ...
  `goods_name` varchar(20) COMMENT '货物名',
  `goods_type` varchar(20) COMMENT '货物类别',
  `goods_price` double COMMENT '单价',
  `produce_time` datetime COMMENT '生产日期',
  `produce_vendor` varchar(50) COMMENT '生产厂商',
  `goods_count` int COMMENT '库存数量',
  `warn_line` varchar(10) COMMENT '库存预警线(数量不低于)',
  `comment` varchar(255) COMMENT '备注'
) 
...
CREATE TABLE `staff_user`  (
  ...
  `user_name` varchar(30) COMMENT '用户名',
  `user_pwd` varchar(50) COMMENT '密码',
  `user_img` varchar(50) COMMENT '头像',
  `user_power` int COMMENT '权限',
  `is_disabled` int COMMENT '是否启用',
  `register_time` datetime COMMENT '注册时间',
  `update_time` datetime COMMENT '更新时间',
